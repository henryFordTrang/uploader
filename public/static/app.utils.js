(function (W, $, B) {
  ...
  AppUtils.prototype.videoShow = function () {
    ...
    // B.postNotification('CLIENT_CHOOSE_IMAGE',{'camare':'3')} ;
    // B.bind('CLIENT_CHOOSE_IMAGE_RESULT', function(object){/*这里使用object对象获取想要的信息*/});
  };
   ...
   * 
   */
  AppUtils.prototype.refreshHome = function () {
   ...
   * 
   */
  AppUtils.prototype.accessCXAPI = function () {
    
    var cmd = "CLIENT_RES_RECENTLY";
    const cataid = 100000015
  const content = {
    resUid: 'cbbac0ad28ca844079e32d57fe148cad',
    resLogo: 'http://home.yd.chaoxing.com/res/images/home/cxjt/applicationWhite/ydb.png?t=18102301',
    resTitle: '阅读本',
    resUrl: 'https://lib.chaoxingbook.com/cxstudy/land.html',
    toolbarType: '2'
  }

    
    B.postNotification(cmd, {cataid,key: content.resUid,content,cataName: ''});
  ...
  AppUtils.prototype.clientOpenUserInfo = function (userId, loginUserFid) {
    ...
    var url = "https://special.zhexuezj.cn/special/course/zt/puid/" + userId +
  ...
  AppUtils.prototype.clientOpenXXTUserInfo = function (userId) {
    var url = location.protocol + "//" + location.host + "/special/course/zt/uid/" + userId +
      "/getUserInfo?callback=?";
    $.getJSON(url, function (data) {
      var user = data.data;
      if (undefined == user) return;
   ...
   * @param flagInfo
   */
  AppUtils.prototype.addBBSTopic = function (
    bbsid, circleId, TopicId, rights, inputType, flagInfo) {
  ...
  AppUtils.prototype.openResCourse = function (cataid, cataName, key, content) {
    B.postNotification("CLIENT_OPEN_RES",
      {"cataid": cataid, "cataName": cataName, "key": key, "content": content});
  };
   ...
   */
  AppUtils.prototype.chapterScribe = function (
    courseId, chapterId, courseName, chapterName, summary, resUrl, author, imags, level, callback) {
    if ($.trim(courseId) == "" || $.trim(chapterId) == "") {
      return;
    }
    var resLogo = "";
  ...
  //专题订阅
  AppUtils.prototype.recScribeImp = function (
    appid, appname, appurl, author, cover, callback, puid, level) {
    appid = appid + "";
    if (appid.indexOf("mooc_") == -1) {
      appid = "mooc_" + appid;
    }
  ...
  AppUtils.prototype.recScribe = function (
    cataid, cataName, key, content, callback, collectionFolder) {
    if ((typeof key == "undefined") || (typeof cataid == "undefined") ||
      (typeof cataName == "undefined") || (typeof content == "undefined")) {
      return;
    }
   ...
   * @param ordinate
   */
  AppUtils.prototype.downSpecial = function (
    appid, appname, appurl, author, cover, puid, downUrl, packageSize, abscissa, ordinate) {
    appid = appid + "";
    if (appid.indexOf("mooc_") == -1) {
      appid = "mooc_" + appid;
    }
    ...
    AppUtils.prototype.showDownloadButton(cataid, cataName, appid, downUrl, packageSize, abscissa,
      ordinate, content);
  };
  /**
   * 显示专题下载按钮
   ...
   * @param content
   */
  AppUtils.prototype.showDownloadButton = function (
    cataid, cataName, key, downUrl, packageSize, abscissa, ordinate, content) {
    if ((typeof key == "undefined") || (typeof cataid == "undefined") ||
      (typeof cataName == "undefined") || (typeof content == "undefined") ||
      (typeof downUrl == "undefined")) {
      return;
    }
   ...
   * @param callback
   */
  AppUtils.prototype.triggerReplyInput = function (
    inputType, groupId, topicInfo, flagInfo, replyInfo, replyLevel, imageWidth) {
   ...
   * @param money
   */
  AppUtils.prototype.pay = function (
    money, orderTitle, category, params, chparams, params_sign, chparams_sign, attach, returntype) {
    if ($.trim(money) == "" ||
      $.trim(orderTitle) == "" ||
      $.trim(category) == "" ||
      $.trim(params) == "" ||
   ...
   */
  AppUtils.prototype.sendRedPackGetMsg = function (
    packetId, createId, receiveId, receiveName, receiveOver) {
   ...
   */
  AppUtils.prototype.recCollection = function (
    type, action, id, sourceId, cataid, content, quoteInfo) {
    if ((typeof type == "undefined") || (typeof action == "undefined") ||
      (typeof sourceId == "undefined") || (typeof cataid == "undefined")) {
      return;
    }
    //当为取消操作时 id 不能为空
