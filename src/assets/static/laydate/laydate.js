...
(function () {
    ...
    var e = window.layui && layui.define, t = {
        ...
        }, i = "laydate", r = ".layui-laydate", o = "layui-this0", s = "laydate-disabled", l = "开始日期超出了结束日期<br>建议重新选择",
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        w(e.elem).on("click", function (e) {
            ...
            w(n[0]).on("click", function (n) {
                ...
                $('.layui-laydate-content table tbody tr td').each(function(){
              	  var _thisDay=$(this).attr('lay-ymd');
              	  var _thisDayFormat=new Date(_thisDay).Format("yyyy-MM-dd");
              	  $(this).attr('thisDay',_thisDayFormat);
              	  if($(this).attr('thisDay')==nowFormat){
              		  $(this).addClass('layui-today');
              	  }
                //   var numR=Math.ceil(Math.random()*4);
                //   if(numR==1){
                //     $(this).append("<span class='unAttSpan small-font lackAttSpan'>缺勤</span>");
                //   }else if(numR==2){
                //     $(this).append("<span class='unAttSpan small-font leaveAttSpan'>早退</span>");
                //   }else if(numR==3){
                //     $(this).append("<span class='unAttSpan small-font lateAttSpan'>迟到</span>");
                //   }else{
                //     $(this).append(
                //       "<span class='outAttSpan'><img class='okAttImg' src='data:image/png;base64,'></span>"
                //     );
                //   }
                })
